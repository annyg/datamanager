...
#> ✔ Cached copy of datamanager 0.1.0 (source) is the latest build
...
#> ✔ Installed datamanager 0.1.0 (github::annyg/datamanager@16865be) (548ms)
#> ✔ Installed R.methodsS3 1.8.2  (619ms)
#> ✔ Installed R.oo 1.27.0  (1.1s)
#> ✔ Installed R6 2.5.1  (1.2s)
#> ✔ Installed askpass 1.2.1  (2s)
#> ✔ Installed R.utils 2.12.3  (2.8s)
#> ✔ Installed base64enc 0.1-3  (2.5s)
#> ✔ Installed bit 4.5.0.1  (2.2s)
#> ✔ Installed bit64 4.6.0-1  (2.9s)
#> ✔ Installed cachem 1.1.0  (1.8s)
#> ✔ Installed cellranger 1.1.0  (1.3s)
#> ✔ Installed callr 3.7.6  (2.7s)
#> ✔ Installed codebookr 0.1.8  (2s)
#> ✔ Installed crayon 1.5.3  (3s)
#> ✔ Installed cli 3.6.3  (4.4s)
#> ✔ Installed DT 0.33  (9.2s)
#> ✔ Installed clipr 0.8.0  (8.7s)
#> ✔ Installed crosstalk 1.2.1  (7.1s)
#> ✔ Installed digest 0.6.37  (5.7s)
#> ✔ Installed curl 6.2.0  (7.5s)
#> ✔ Installed dplyr 1.1.4  (5.3s)
#> ✔ Installed data.table 1.16.4  (7.5s)
#> ✔ Installed Rcpp 1.0.14  (15.5s)
#> ✔ Installed evaluate 1.0.3  (3.8s)
#> ✔ Installed fansi 1.0.6  (3.9s)
#> ✔ Installed fastmap 1.2.0  (3.4s)
#> ✔ Installed flextable 0.9.7  (3.2s)
#> ✔ Installed fontBitstreamVera 0.1.1  (3.2s)
#> ✔ Installed bslib 0.9.0  (17s)
#> ✔ Installed fontawesome 0.5.3  (2.7s)
#> ✔ Installed fontLiberation 0.1.0  (3.6s)
#> ✔ Installed fontquiver 0.2.1  (2.6s)
#> ✔ Installed forcats 1.0.0  (2.5s)
#> ✔ Installed fs 1.6.5  (2.3s)
#> ✔ Installed gdtools 0.4.1  (2.3s)
#> ✔ Installed generics 0.1.3  (2.1s)
#> ✔ Installed glue 1.8.0  (2s)
#> ✔ Installed haven 2.5.4  (2.1s)
#> ✔ Installed highr 0.11  (2.2s)
#> ✔ Installed hms 1.1.3  (2.1s)
#> ✔ Installed htmltools 0.5.8.1  (2.2s)
#> ✔ Installed htmlwidgets 1.6.4  (2.4s)
#> ✔ Installed httpuv 1.6.15  (2.5s)
#> ✔ Installed jquerylib 0.1.4  (2.4s)
#> ✔ Installed jsonlite 1.8.9  (2.4s)
#> ✔ Installed labelled 2.14.0  (2.4s)
#> ✔ Installed later 1.4.1  (2.6s)
#> ✔ Installed lazyeval 0.2.2  (2.7s)
#> ✔ Installed lifecycle 1.0.4  (3.1s)
#> ✔ Installed knitr 1.49  (4.8s)
#> ✔ Installed magrittr 2.0.3  (3.4s)
#> ✔ Installed mime 0.12  (3.1s)
#> ✔ Installed memoise 2.0.1  (3.7s)
#> ✔ Installed officer 0.6.7  (3.1s)
#> ✔ Installed openssl 2.3.2  (2.9s)
#> ✔ Installed pillar 1.10.1  (2.8s)
#> ✔ Installed pkgconfig 2.0.3  (2.3s)
#> ✔ Installed processx 3.8.5  (2.3s)
#> ✔ Installed promises 1.3.2  (2.1s)
#> ✔ Installed ps 1.8.1  (2.2s)
#> ✔ Installed purrr 1.0.4  (2.5s)
#> ✔ Installed ragg 1.3.3  (2.3s)
#> ✔ Installed rappdirs 0.3.3  (2.8s)
#> ✔ Installed readr 2.1.5  (3.1s)
#> ✔ Installed rematch 2.0.0  (3s)
#> ✔ Installed readxl 1.4.3  (3.5s)
#> ✔ Installed rio 1.2.3  (4.2s)
#> ✔ Installed rlang 1.1.5  (4.2s)
#> ✔ Installed sass 0.4.9  (3.9s)
#> ✔ Installed rmarkdown 2.29  (4.5s)
#> ✔ Installed sys 3.4.3  (2.7s)
#> ✔ Installed stringr 1.5.1  (3.7s)
#> ✔ Installed systemfonts 1.2.1  (3.4s)
#> ✔ Installed stringi 1.8.4  (4.9s)
#> ✔ Installed tibble 3.2.1  (2.2s)
#> ✔ Installed textshaping 1.0.0  (3s)
#> ✔ Installed tidyselect 1.2.1  (2.2s)
#> ✔ Installed tidyr 1.3.1  (2.9s)
#> ✔ Installed tinytex 0.54  (2.7s)
#> ✔ Installed tzdb 0.4.0  (2.4s)
#> ✔ Installed utf8 1.2.4  (2.3s)
#> ✔ Installed uuid 1.2-1  (2.3s)
#> ✔ Installed vctrs 0.6.5  (2.3s)
#> ✔ Installed webshot 0.5.5  (2s)
#> ✔ Installed vroom 1.6.5  (2.5s)
#> ✔ Installed withr 3.0.2  (2s)
#> ✔ Installed writexl 1.5.1  (1.8s)
#> ✔ Installed xfun 0.50  (1.7s)
#> ✔ Installed xml2 1.3.6  (1.5s)
#> ✔ Installed yaml 2.3.10  (1.3s)
#> ✔ Installed zip 2.3.2  (1.1s)
#> ✔ 1 pkg + 91 deps: upd 1, added 90 [55.1s]
library(datamanager)
```
